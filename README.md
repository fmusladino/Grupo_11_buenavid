...
-Bruno Cavilla, tengo 38 años. Soy del interior de la provincia de Buenos Aires, ahora viviendo en Olivos. 
Tengo una pyme que se dedica al servicio tecnico de equipamiento laser de estética.
Siempre quise saber programar, lo intente aprender en varias ocasiones (incluida una en DH pre pandemia), pero desisti. Espero esta vez lograr entender y aprender.
Tambien empece a estudiar sommelier pero no termine por el trabajo que tenia en ese momento, soy un apasionado del vino. 
Mi intencion con el curso era aprender Js para luego poder aprender a programar en Solidity, tambien me interesa la rama de Data Scientist con Python.
